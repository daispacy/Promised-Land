...
extension String {
    ...
    func stringByAddHtml(_ font:UIFont? = nil,
        ...
        DispatchQueue.global().async {
            ...
            if let data = "<html><head><style type='text/css'>body {font-size:\(16); color:#ffffff; font-family:'\(UIFont.systemFont(ofSize: 16).familyName)'} a {color:#e6c400;text-decoration: none;}</style></head><body>\(self)</body></html>".data(using: String.Encoding.utf8, allowLossyConversion: true) {
